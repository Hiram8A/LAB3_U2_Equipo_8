...
#define LIGHT_PIN_ON B4
#define SYS_PIN_ON   B1
#define PERSIANA_1   B6
#define PERSIANA_2   B7
#define FAN_ON       B3
...
#define LIGHT_CH1       CH0
#define LIGHT_CH2       CH1
#define LIGHT_CH3       CH2
#define POT_1           AN9
#define POT_2           AN8
#define POT_3           AN1
